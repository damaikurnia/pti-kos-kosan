<%-- 
    Document   : about
    Created on : May 23, 2013, 2:54:04 PM
    Author     : user
--%>
					...
					<div id="content">
						<div id="box1">
							...
							<p>
                                                            ...
                                                            Website yang menampung data-data kost yang terletak di sekitar kampus Universitas Sanata Dharma Paingan, Maguwoharjo, Depok, Sleman. <br>
                                                            Terdapat kos laki-laki maupun perempuan, dengan harga terjangkau, dan fasilitas memadai. <br>
                                                            Selain itu lokasinya juga strategis, sehingga tidak menyulitkan transportasi mahasiswa<br>
                            				</p>
