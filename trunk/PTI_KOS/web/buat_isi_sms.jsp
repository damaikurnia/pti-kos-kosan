<%-- 
    Document   : buat_isi_sms
    Created on : Jun 1, 2013, 12:53:37 AM
    Author     : Mich
--%>
        ...
        <div id="bg">
            <div id="outer">
                ...
                <div id="main">
                    ...
                    <div id="content">
                        <form  action="InsertSMS">
                        <strong>Nomor SMS</strong><br>
                        <input type="text" name="nomor" size="32" maxlength="32" /><br><br>
                        <textarea name="isiSMS" id="des" cols="50%" rows="8" class="af"></textarea><br>
